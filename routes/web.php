...
Route::resource('permohonanrumah', 'PermohonanRumahController');

Route::resource('permohonaninventaris','PermohonanInventarisController');

// Route::post('rumah', 'RumahController@storeFile');
